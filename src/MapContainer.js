...
var locations = [
    {
        title: 'Katedra Wawelska',
        location: {
            lat: 50.054332782787824,
            lng: 19.9352044712264
        },
        id: '4c9b6e4ab8e9224b2b47563d'
    },
    {
        title: 'Kościół św. Barbary',
        location: {
            lat: 50.061451348141595,
            lng: 19.939542236386313
        },
        id: '5013d76ee4b0c79e480114f3'
    },
    {
        title: 'Kościół św Krzyża',
        location: {
            lat: 50.06336527146654,
            lng: 19.9431574344635
        },
        id: "4f75d7a8e4b02ca6e4ad75b8"
    },
    {
        title: 'Kościół św Wojciecha',
        location: {
            lat: 50.0608642475812,
            lng: 19.937513704864894
        },
        type: "churches",
        id: "4d8f276d788c5481f1c848fd"
    },
    {
        title: 'Kościół św Andrzeja',
        location: {
            lat: 50.058249397396914,
            lng: 19.93808568189959
        },
        id: "514a07ece4b095e3f099c00a"
    },
    {
        title: 'Kościół Matki Boskej Snieżnej',
        location: {
            lat: 50.06131946813931,
            lng: 19.943152340036985
        },
        id: "4f53385fe4b028a920363a6b"
    },
    {
        title: 'Kościół św Anny',
        location: {
            lat: 50.06218502782165,
            lng: 19.933408530075234
        },
        id: "4f00b3e461af974bcece01e6"
    },
    {
        title: 'Kościół św Marcina',
        location: {
            lat: 50.055224953124586,
            lng: 19.93840928171233
        },
        id: "505ece6be4b0f0e1a23bb591"
    },
    {
        title: 'Klasztor Bernardynów',
        location: {
            lat: 50.05368292107886,
            lng: 19.938828560540607
        },
        id: "4fb772fae4b08bf86358e82f"
    },
    {
        title: 'Kościół sw Katarzyny',
        location: {
            lat: 50.049485416339685,
            lng: 19.940990209579468
        },
        id: "4eec9cb9f9ab8c5a00a379b1"
    },
    {
        title: 'Kościół św. Jana Chrzciciela i św. Jana Ewangelisty',
        location: {
            lat: 50.06306121750307,
            lng: 19.938544467097152
        },
        id: "51333504e4b018c1c38b6ec3"
    }
];
...
export default class MapContainer extends Component {
    ...
    hideMenu() {
        ...
        document.getElementsByClassName("hamburger")[0].style.width = "40px";
    }
    ...
    loadMap() {
        ...
        if (this.props && this.props.google) { // checks to make sure that props have been passed
            ...
            node.onerror = function () {
                alert("We couldn't load google map.Please try again later");
            }
            // ==================
            // ADD MARKERS TO MAP
            // ==================
            ...
            var populateInfoWindow = function (marker, infowindow) {
                ...
                items.forEach(item => {
                    if (marker.id === item.id) {
                        ...
                        content = '<div><div id = "content"></div> <p>' + item.categories[0].name + '</p> adres: ' + item.location.formattedAddress +
                            '</div>';
                ...
                if (infowindow.marker !== marker) {
                    ...
                    infowindow.setContent('<div><h3>' + marker.title + '</h3 ><img src="https://upload.wikimedia.org/wikipedia/commons/d/dc/Foursquare_logo.svg" alt="foursquare-logo" height="50px">' + content + '</div>');
            ...
            items.onerror = function () {
                alert("we couldn't load foursquare info")
    ...
    render() {
        ...
        return (
            ...
            <div className="container">
                <div className="hamburger" tabIndex={3} role="button" aria-label="show-menu" onClick={this.showMenu} onKeyPress={this.showMenu}>&#9776;</div>
                <div className="sidebar">

                    <input aria-label="search" className="search" placeholder="search" onInput={this.filteredPlaces} />
                    <button onClick={this.hideMenu} onKeyPress={this.hideMenu} aria-label="hide-menu">X</button>
                    <ul>

                        {this.state.filteredPlaces.map(place => <li key={place} role="button" id={place} tabIndex={1} className={place} onKeyPress={this.handleClick} onClick={this.handleClick}> {place}</li>)}
                    </ul>
